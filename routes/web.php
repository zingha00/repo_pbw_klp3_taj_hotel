...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/reservation/{id}/summary', [ReservationController::class, 'summary'])->name('reservation.summary');
    ...
    Route::get('/my-reservation', [ReservationController::class, 'myReservations'])->name('reservations.my');
